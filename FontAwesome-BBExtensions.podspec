Pod::Spec.new do |s|
  ...
  s.watchos.exclude_files = "FontAwesome-BBExtensions/UIButton*.{h,m}"
  s.watchos.pod_target_xcconfig = {"GCC_PREPROCESSOR_DEFINITIONS" => "$(inherited) -DBB_FONT_AWESOME_APP_EXTENSION=1"}
